      ...
      <header className="header d-flex align-center justify-between">
         <Link to="/">
            <div className="header__left d-flex align-center">
               <div className="header-left__image">
                  <img width={40} height={40} src='/img/header-left.png' alt="Logotype" />
               </div>
         ...
         <div className="header__right d-flex align-center">
            <div className="header-right__basket d-flex align-center cu-p" onClick={() => { openBasket() }}>
               <button>
