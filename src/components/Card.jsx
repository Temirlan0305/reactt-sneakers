...
function Card ({title, price, image, onFavourite, onPlus}) {
      ...
      return (
            <div className="section-bottom__column">
                 ...
                 {isFavorite ? <div className="section-bottom__like" onClick={onClickFavorite}>
                  ...
                  <div className="section-bottom__image">
                        <img width={110} height={110} src={image} alt="sneakers" />
                  </div>
